...
#
# Generated by Vivado on Thu Nov 18 01:00:51 KST 2021
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../../../src/common_ip/clk_gen" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../../../src/common_ip/clk_gen" \
    "$ref_dir/../../../../../../src/common_ip/clk_gen/clk_gen_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
