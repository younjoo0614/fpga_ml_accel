...
HD_PWD='C:/Users/younj/Desktop/dsd_final/build/hw_test/hw_test.runs/sram_32x1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_32x1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sram_32x1024.tcl
