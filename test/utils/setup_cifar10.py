...
def download_dataset():
    if not os.path.exists("./data/dataset_cifar10/"):
        os.makedirs("./data/dataset_cifar10/")
    print("Download the CIFAR-10 dataset from https://www.cs.toronto.edu/~kriz/cifar.html")
    if not os.path.exists("./data/dataset_cifar10/cifar-10-python.tar.gz"):
        ...
        urllib.request.urlretrieve("https://www.cs.toronto.edu/~kriz/cifar-10-python.tar.gz", \
                                   "./data/dataset_cifar10/cifar-10-python.tar.gz")
